...
function HomeContent() {
  ...
  return (
    <div className="font-[family-name:var(--font-tajawal)] bg-gray-50 text-right">
      ...
      {/* Meta Pixel Code - Dental Page Specific */}
      <Script id="meta-pixel-dental" strategy="afterInteractive">
        {`
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              املأ النموذج أدناه وسيتم تحويلك تلقائياً إلى واتساب مع بياناتك لتأكيد الموعد
            </p>
          </motion.div>
